...
<nav class="bg--gradientWhite">
    ...
    <div class="flex items-center justify-between">
        <div>
            <a href="index.php"><img class="mw3 pl4 v-mid" src="IMG/logo/logo.png" alt="[Logo estação geek luderia]" title="Logo estação geek luderia"></a>
        </div>
        <div class="container mr3">
    ...
    <!-- MENU DE OPCOES -->
    <div class="menuDisable">
        <ul class="flex flex-wrap justify-end bg--gradientSecundary ma0"> <a href=""></a>
            <li class="list ma2 f_body br2"><a href="jogos.php" class="no-underline pa2 grayScale--regular">Jogos</a></li>
