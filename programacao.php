...
<head>
  ...
  <title>Estação Geek - Programação</title>
  ...
  <main>
    ...
    <section class="flex items-center flex-column">
      ...
      <article class="flex items-center ph3 mv3 eventosScale">
        ...
        <!-- BLOCO DA IMAGEM -->
        <div class="w-50 mw5 h-100 br3 br--right">
           <img class="h-100 br3 br--right" src="IMG/slide/example2.jpg" alt="">
        </div>
      </article>
